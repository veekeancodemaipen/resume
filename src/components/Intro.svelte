...
<div class="flex flex-wrap flex-col sm:flex-row print:flex-row text-sm sm:text-base">
	...
	<h2
		class="flex-none order-first sm:order-none print:order-none font-bold text-4xl sm:text-2xl md:text-3xl lg:text-6xl text-center p-4 print:pt-0"
	>
		{name}
		<span class="block -mt-1 text-base lg:text-lg font-normal">({nickname})</span>
	</h2>
